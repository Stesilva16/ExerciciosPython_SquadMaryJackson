...
# Impressão da mensagem amigável utilizando as variáveis
print(f"Olá {nome}, prazer em te conhecer. Sou de {lugar}, tenho {idade} anos e estou migrando de área. Atualmente, sou {profissao}.")
